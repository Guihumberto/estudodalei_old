<template>
    ...
    <v-row align-content-space-between class="mb-2">
        ...
        <v-col cols="12" sm="4">
            <v-btn-toggle>
                <leges-dialogs-otherLaws @listOtherLaws="OtherLaws($event)" />
                <leges-dialogs-estrutura :estrutura="estruturaList" />
                <leges-dialogs-print :law="nameLaw" :textLaw="textLaw.textComplete" />
    ...
    <!-- text law -->
    <v-card outlined v-if="textLaw.text" class="pt-5">
        ...
        <v-card-text>
            <div>
                <div v-for="(item, index) in textLaw.text" :key="index" :style="{ fontSize: font.fontSize + 'px'}">
                    <p v-if="item.estrutura" v-show="!artsFilterActive" class="font-weight-medium text-center" v-text="item.textLaw"></p>
